...
public class MainGame extends LayoutGameActivity {
	...
	public static int StartCheck=0;
	//Ads
	/*
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (bundle!=null) {
				...
				if ("punch".equalsIgnoreCase(data)) {
					//view.flyCow();	
					mAirPlane.setPosition(mAirPlane.getX(), mAirPlane.getY() + 80.0f);
					StartCheck=1;
					punch=1;
					
				}
				if ("circle".equalsIgnoreCase(data)) {
					//view.flyCow();	
					//mAirPlane.setPosition(mAirPlane.getX(), mAirPlane.getY() + 80.0f);
					//StartCheck=1;
					circle=1;
    ...
    */
	...
	public void update () {		
		...
		if (StartCheck==1 ) {
			if (mAirPlane.getY() > 0) {
				mAirPlane.setPosition(mAirPlane.getX(), mAirPlane.getY() - 1.0f);
			}
		}
